      ...
      >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div 
            ...
            className="flex flex-col items-center p-6 bg-white/60 backdrop-blur-lg rounded-2xl border border-white/40 shadow-xl shadow-slate-200/20"
          >
            <div className="w-12 h-12 bg-indigo-100 text-indigo-600 rounded-xl flex items-center justify-center mb-4">
              <FileText size={24} />
            </div>
            <h3 className="text-lg font-bold text-slate-900 mb-2">Smart Templates</h3>
            <p className="text-slate-600 text-center">Professional templates that adapt to your brand automatically.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 text-center">Create and send invoices in seconds, not hours.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 text-center">Never lose track of a payment with secure cloud storage.</p>
          </motion.div>
        </div>
